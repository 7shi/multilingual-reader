...
for m in gemma3:4b gemma3n:e4b gemma2:9b gemma3:12b gemma3:27b phi4 command-r7b aya-expanse:8b aya-expanse:32b qwen3:4b qwen3:14b qwen3:30b qwen3:32b llama3.3 llama4:scout gpt-oss:20b gpt-oss:120b mistral-small3.2 mixtral:8x7b mixtral:8x22b; do
    echo "======== $m ========"
    m2=${m/:/-}
    if [[ "$m" == "gemma2:9b" ]]; then
