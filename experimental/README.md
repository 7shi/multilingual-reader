...
- **[10/](10/)**: 実験06〜09の成果を受け、他者評価アプローチを `trtools review` として `trtools` に統合。実験09で推敲効果が高かった5言語（bg・eu・et・sl・hu）で translate → eval → review → eval のフルパイプラインを動作検証する（実行時間約3時間半）。
