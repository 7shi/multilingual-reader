...
同じ出力をGemini 2.5 Flashの5項目評価で測定：
...
- ministral-3 は 8b が高得点だが、それ以外は 14b も含めて壊滅的。
...
1. **gpt-oss-120b**（モデルが巨大なため動作環境を選ぶ）
   - **0-20**: 速度優先
   - **2-05, tr6-05**: 教育利用
   - **tr5-05/20**: 今回の測定では好成績だが、変動がありtr6と同程度と思われるため非推奨

1. **ministral-3-8b**（サイズの割に高性能だがタスクを選ぶ）
   - **2-05**: 教育利用

1. **ministral-3-14b**（タスクを選ぶ）
   - **0-05, tr4-05**: 速度優先
