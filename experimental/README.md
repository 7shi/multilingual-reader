...
- **(nt)効果**: qwen3-14bはtr6で大幅改善（全実験最高得点）
...
**結論**: tr5で明確な優位性が認めらるのはgemma2-9bとgemma3-4bだが、実用範囲なのはgemma3-4bのみ。
...
本実験により、**「複雑な推論システム = 高品質翻訳」という従来仮説**は客観評価により否定され、**「適切なモデル選択 + シンプルな直接出力 = 最高効率」**が実証されました。
