...
CRITICAL GUIDELINES 3-6 into the rubric directly, and README.md section 3 records what
...
# guidelines' defect taxonomy, and README.md section 3 is the record of what that costs.
LEVEL_SETS["bands"] = [
