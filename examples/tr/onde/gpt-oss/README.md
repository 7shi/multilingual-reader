...
**高品質 (90点以上):** スペイン語 (es), フランス語 (fr), イタリア語 (it), 日本語 (ja), ポルトガル語 (pt)

**実用範囲 (80〜89点):** スウェーデン語 (sv), ウクライナ語 (uk), オランダ語 (nl), ドイツ語 (de), アラビア語 (ar), トルコ語 (tr), チェコ語 (cs), ブルガリア語 (bg)

**中品質 (60〜79点):** ロシア語 (ru), 中国語 (zh), インドネシア語 (id), ハンガリー語 (hu), ペルシア語 (fa), インターリングア (ia), ウルドゥー語 (ur), ポーランド語 (pl), 朝鮮語 (ko), ヘブライ語 (he), フィンランド語 (fi), セルビア語 (sr)
...
- **フォーマットの喪失**: 特に対話スクリプトに必須である話者タグ（Camille: や Luc:）を頻繁に出力し忘れるという構造上の欠陥が見られました。（ドイツ語、中国語、朝鮮語、アラビア語、ヘブライ語、ペルシア語に加え、ポルトガル語、ロシア語、ウクライナ語、ポーランド語、チェコ語、オランダ語、スウェーデン語でも発生）

イタリア語は 95 点で自然さ・専門用語ともに非常に安定していました。ポルトガル語も内容面では高品質ですが、話者タグ脱落のため減点されています。オランダ語・スウェーデン語・チェコ語・ウクライナ語は意味保持自体は良好でも、直訳調や構造崩れが残り、ロシア語・ポーランド語・インターリングアは完成度の揺らぎがやや大きい結果となりました。
