...
**高品質 (90点以上):** スペイン語 (es), フランス語 (fr), 日本語 (ja)

**実用範囲 (80〜89点):** ドイツ語 (de), アラビア語 (ar), トルコ語 (tr), ブルガリア語 (bg)

**中品質 (60〜79点):** 中国語 (zh), インドネシア語 (id), ハンガリー語 (hu), ペルシア語 (fa), ウルドゥー語 (ur), 朝鮮語 (ko), ヘブライ語 (he), フィンランド語 (fi), セルビア語 (sr)
...
- **フォーマットの喪失**: 特に対話スクリプトに必須である話者タグ（Camille: や Luc:）を頻繁に出力し忘れるという構造上の欠陥が見られました。（ドイツ語、中国語、朝鮮語、アラビア語、ヘブライ語、ペルシア語などで発生）
