...
**高品質 (90点以上):** スペイン語 (es), フランス語 (fr), カタルーニャ語 (ca), イタリア語 (it), 日本語 (ja), ベトナム語 (vi), ポルトガル語 (pt)

**実用範囲 (80〜89点):** スウェーデン語 (sv), ウクライナ語 (uk), オランダ語 (nl), ドイツ語 (de), アラビア語 (ar), トルコ語 (tr), チェコ語 (cs), ブルガリア語 (bg)

**中品質 (60〜79点):** ロシア語 (ru), 中国語 (zh), インドネシア語 (id), ハンガリー語 (hu), ペルシア語 (fa), インターリングア (ia), ウルドゥー語 (ur), ポーランド語 (pl), ギリシャ語 (el), 朝鮮語 (ko), ヘブライ語 (he), フィンランド語 (fi), セルビア語 (sr), ラトビア語 (lv)

**致命的な欠陥 (60点未満):** エスペラント (eo), ルーマニア語 (ro), マラヤーラム語 (ml), エストニア語 (et), カンナダ語 (kn), リトアニア語 (lt), ヒンディー語 (hi), テルグ語 (te), タミル語 (ta)
...
- **状況認識の漏出**: セルビア語やエスペラント語などで、翻訳の途中に突然「The conversation ended.」や「Need final translation:」といった状況認識が出力される問題が発生しました。
- **フォーマットの喪失**: 特に対話スクリプトに必須である話者タグ（Camille: や Luc:）を頻繁に出力し忘れるという構造上の欠陥が見られました。（ドイツ語、中国語、朝鮮語、アラビア語、ヘブライ語、ペルシア語に加え、ポルトガル語、ロシア語、ウクライナ語、ポーランド語、チェコ語、オランダ語、スウェーデン語、ルーマニア語、リトアニア語でも発生）

カタルーニャ語とベトナム語は 90 点台前半〜後半で、自然さ・専門用語ともに非常に安定していました。ポルトガル語も内容面では高品質ですが、話者タグ脱落のため減点されています。ギリシャ語とラトビア語は意味保持自体は可能でも、専門用語の揺れや直訳調が残ります。ルーマニア語とリトアニア語は話者タグ脱落と重複行が重なって対話構造が崩れ、マラヤーラム語も正書法と転写の乱れが大きく、全体として完成度の揺らぎが大きい結果となりました。
