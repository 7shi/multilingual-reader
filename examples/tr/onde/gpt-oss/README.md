...
**中品質 (60〜79点):** 中国語 (zh), インドネシア語 (id), ハンガリー語 (hu), 朝鮮語 (ko), フィンランド語 (fi), セルビア語 (sr)
...
- **フォーマットの喪失**: 特に対話スクリプトに必須である話者タグ（Camille: や Luc:）を頻繁に出力し忘れるという構造上の欠陥が見られました。（ドイツ語、中国語、朝鮮語、アラビア語などで発生）
