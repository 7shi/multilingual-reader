...
[examples/](examples/) には各トピック × 各言語の参照訳テキストファイルが格納されています。原文はフランス語で、英語・スペイン語はフランス語から直接翻訳していますが、ドイツ語・日本語・中国語は英語を経由した重訳です。
...
| スペイン語   | 96.75 |  4 | フランス語 | Gemma 4 26B | Gemini 3.1 Pro |
| 中国語   | 96.50 |  4 | 英語 | Gemma 4 26B | Gemini 3.1 Pro |
| ドイツ語    | 96.25 |  4 | 英語 | Gemma 4 26B | Gemini 3.1 Pro |

全言語とも校正を施しており、参照訳として実験のベースラインに使用できる水準です。
